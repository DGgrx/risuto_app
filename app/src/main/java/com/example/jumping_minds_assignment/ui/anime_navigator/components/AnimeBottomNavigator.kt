package com.example.jumping_minds_assignment.ui.anime_navigator.components
...
fun NewsBottomNavigationPreview() {
    Jumping_minds_assignmentTheme(dynamicColor = false) {
        AnimeBottomNavigation(items = listOf(
